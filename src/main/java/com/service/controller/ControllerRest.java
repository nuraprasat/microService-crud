...
public class ControllerRest {
	...
	public ResponseEntity < UserInformation > updateResource(@RequestParam("email") String email, @PathVariable("id") Integer id) throws UserInformationNotFoundException {
		UserInformation newCustomer = userInformationService.updateUser(email, id);
